            ...
            <div className="relative">
              ...
              {userMenuOpen && user && (
                <>
                  ...
                  />
                  <div
                    className="absolute right-0 mt-2 w-56 rounded-xl border border-app-border bg-white py-2 shadow-lg z-50 animate-fade-in"
                  ...
                  >
                    ...
                    <div onClick={() => setUserMenuOpen(false)}>
                      ...
                      {user.isAdmin && (
                        <Link to="/" className="dropdown-link text-app-orange">
